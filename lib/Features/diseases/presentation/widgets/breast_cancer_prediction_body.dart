...
class BreastCancerPredictionBody extends StatefulWidget {
  const BreastCancerPredictionBody({
    super.key,
  });

  @override
  State<BreastCancerPredictionBody> createState() =>
      _BreastCancerPredictionBodyState();
}

class _BreastCancerPredictionBodyState
    extends State<BreastCancerPredictionBody> {
