...
import 'package:team/Features/diseases/diabetes_screen/widgets/diabetes_prediction_input_form.dart';
...
class DiabetesPredictionInputBody extends StatelessWidget {
  const DiabetesPredictionInputBody({
    super.key,
  });
